...
Item {
  ...
  readonly property int popupWidth: Math.min(560, root.parentWindow.width - theme.barPadding * 2)
  readonly property int popupHeight: Math.min(580, root.parentWindow.screen.height - theme.barHeight - theme.barPadding * 2)
