...
mapkey("n", "<C-f>", "<cmd>silent !tmux neww tmux-sessionizer<CR>")
mapkey("n", "<M-h>", "<cmd>silent !tmux neww tmux-sessionizer -s 0<CR>")
mapkey("n", "<M-t>", "<cmd>silent !tmux neww tmux-sessionizer -s 1<CR>")
mapkey("n", "<M-n>", "<cmd>silent !tmux neww tmux-sessionizer -s 2<CR>")
mapkey("n", "<M-s>", "<cmd>silent !tmux neww tmux-sessionizer -s 3<CR>")
